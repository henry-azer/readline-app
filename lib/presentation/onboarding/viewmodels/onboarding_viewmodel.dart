...
/// Reading levels available for selection in the assessment step.
class ReadingLevel {
  final String id;
  final String label;
...
final List<ReadingLevel> readingLevels = List.unmodifiable([
  ReadingLevel(
    id: 'beginner',
...
int wpmForLevel(String levelId) {
  switch (levelId) {
    case 'beginner':
      return 100;
    case 'intermediate':
...
class OnboardingViewModel {
  ...
  int get currentStep => step$.value;
  String get selectedLevel => selectedLevel$.value;
