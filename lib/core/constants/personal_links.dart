class PersonalLink {
  ...
  const PersonalLink({required this.name, required this.link});
}
...
class PersonalLinks {
  ...
  static const List<PersonalLink> links = [
    ...
    PersonalLink(
      name: 'linkedin',
      link: 'https://www.linkedin.com/in/henry-azer',
    ),
    ...
    PersonalLink(
      name: 'support-url',
      link:
          'https://docs.google.com/forms/d/e/1FAIpQLSd0O2cl3-oreDnkc0TCqxjYL-y_mBCZnLTgIwg8wRKmCBvkuA/formResponse',
    ),
    PersonalLink(name: 'support-app-name-entry', link: 'entry.404388434'),
    ...
    PersonalLink(
      name: 'bug-reporting-url',
      link:
          'https://docs.google.com/forms/d/e/1FAIpQLSdF9tzd8VD0V8cDeMFCkaOGgguIw5oiWSvFT4EZQjClzKn5_A/formResponse',
    ),
    PersonalLink(
      name: 'bug-reporting-app-name-entry',
      link: 'entry.2032870792',
    ),
    ...
    PersonalLink(
      name: 'bug-reporting-description-entry',
      link: 'entry.326955045',
    ),

    PersonalLink(
      name: 'rating-url',
      link:
          'https://docs.google.com/forms/d/e/1FAIpQLSc30DiuLt9yw8Eo5vmBWOA3DQXt3cFQsgVpKBrNmddKv-SmMg/formResponse',
    ),
    PersonalLink(name: 'rating-app-name-entry', link: 'entry.1209049190'),
