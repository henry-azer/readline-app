...
class AnalyticsRepositoryImpl implements ReadingSessionRepository {
  ...
  Future<ReadingSession> createSession({
    ...
    try {
      ...
      throw AnalyticsRepositoryException('Failed to create session: $e');
    }
  }
  ...
  Future<void> updateSession(ReadingSession session) async {
    try {
      ...
      throw AnalyticsRepositoryException('Failed to update session: $e');
    }
  }
  ...
  Future<ReadingSession> completeSession({
    ...
    try {
      ...
      if (existingSession == null) {
        throw AnalyticsRepositoryException('Session not found: $sessionId');
      }
      ...
      throw AnalyticsRepositoryException('Failed to complete session: $e');
    }
  }
  ...
  Future<ReadingSession?> getSessionById(int id) async {
    try {
      ...
      throw AnalyticsRepositoryException('Failed to get session: $e');
    }
  }
  ...
  Future<List<ReadingSession>> getSessionsForPdf(String pdfId) async {
    try {
      ...
      throw AnalyticsRepositoryException('Failed to get sessions for PDF: $e');
    }
  }
  ...
  Future<List<ReadingSession>> getSessionsByDateRange({
    ...
    try {
      final sessionModels = await localDataSource.getSessionsByDateRange(startDate, endDate);
      return sessionModels.map((model) => ReadingSession.fromModel(model)).toList();
    } catch (e) {
      throw AnalyticsRepositoryException('Failed to get sessions by date range: $e');
    }
  }
  ...
  Future<List<ReadingSession>> getRecentSessions({int limit = 20}) async {
    try {
      ...
      throw AnalyticsRepositoryException('Failed to get recent sessions: $e');
    }
  }
  ...
  Future<ReadingSession?> getActiveSession() async {
    try {
      ...
      throw AnalyticsRepositoryException('Failed to get active session: $e');
    }
  }
  ...
  Future<void> deleteSession(int sessionId) async {
    try {
      ...
      throw AnalyticsRepositoryException('Failed to delete session: $e');
    }
  }
  ...
  Future<ReadingStats> getReadingStats({
    ...
    try {
      ...
      throw AnalyticsRepositoryException('Failed to get reading stats: $e');
    }
  }
  ...
  Future<List<ReadingProgress>> getReadingProgress({
    ...
    try {
      ...
      throw AnalyticsRepositoryException('Failed to get reading progress: $e');
    }
  }
  ...
  Future<ReadingStreak> getReadingStreak() async {
    try {
      ...
      throw AnalyticsRepositoryException('Failed to get reading streak: $e');
    }
  }
  ...
  Future<List<ReadingGoal>> getReadingGoals() async {
    try {
      ...
      throw AnalyticsRepositoryException('Failed to get reading goals: $e');
    }
  }
  ...
  Future<void> updateReadingGoal(ReadingGoal goal) async {
    try {
      ...
      throw AnalyticsRepositoryException('Failed to update reading goal: $e');
    }
  }
...
class AnalyticsRepositoryException implements Exception {
  ...
  @override
  String toString() => 'AnalyticsRepositoryException: $message';
}
